...
▀█████████▄           ██       ████████
██▀ │UU_Fs ﹏ @A_j_o_k_e_r
│تم تطوير وبرمجة السورس من قبل Deboᐂ .
│@UU_Fs
#-------------------------------------------------------------------
]]
...
msg.TheRank =  'مبرامج السورس'
msg.Rank = 1

elseif msg.sender_user_id_ == 1530511556 then 
...
elseif msg.sender_user_id_ == 1572035435 then 
msg.TheRank =  'مطور السورس'
msg.Rank = 1
...
function tdcli_update_callback(data)
	...
	download_file('https://raw.githubusercontent.com/Debosss11000/Debosss/main/inc/Run.lua','./inc/Run.lua')
	EditMsg(data.message_.chat_id_,data.message_.id_,'40% - |█████       |')
	download_file('https://raw.githubusercontent.com/Debosss11000/Debosss/main/inc/locks.lua','./inc/locks.lua')
	EditMsg(data.message_.chat_id_,data.message_.id_,'60% - |███████     |')
	download_file('https://raw.githubusercontent.com/Debosss11000/Debosss/main/inc/Script.lua','./inc/Script.lua')
	EditMsg(data.message_.chat_id_,data.message_.id_,'80% - |█████████   |')
	download_file('https://raw.githubusercontent.com/Debosss11000/Debosss/main/inc/functions.lua','./inc/functions.lua')
	download_file('https://raw.githubusercontent.com/Debosss11000/Debosss/main/plugins/zhrfa.lua','./plugins/zhrfa.lua')
	download_file('https://raw.githubusercontent.com/Debosss11000/Debosss/main/plugins/games.lua','./plugins/games.lua')
